...
func toFirewallRules(ctx context.Context, networkSpec apiv1.NetworkingSpec) ([]domain.FirewallRule, error) {
...
func toFirewallRule(ctx context.Context, rule apiv1.FirewallRuleSpec) (domain.FirewallRule, error) {
